...
def test_in_range():
  ...
  timestamp = ("%s") % time.mktime(time.strptime("2011-10-01 01:01:01",time_format))
  assert ArgusCapture().in_range(start, end, timestamp)
  timestamp = ("%s") % time.mktime(time.strptime("2014-10-01 01:01:01",time_format))
...
if __name__ == '__main__':
    ...
    argus_capture.get_alarms_in_range("2013-12-01 01:01:01", "2014-01-01 01:01:01")
